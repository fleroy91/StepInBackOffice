...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { action_kind: @reward.action_kind, code: @reward.code, nb_points: @reward.nb_points, when: @reward.when }
    end
  ...
  test "should update reward" do
    put :update, id: @reward, reward: { action_kind: @reward.action_kind, code: @reward.code, nb_points: @reward.nb_points, when: @reward.when }
    assert_redirected_to reward_path(assigns(:reward))
  end
